package com.harmony.umbrella.jwt.configurers;

import com.harmony.umbrella.jwt.JwtTokenDecoder;
import com.harmony.umbrella.jwt.JwtTokenExtractor;
import com.harmony.umbrella.jwt.matcher.ExcludeRequestMatcher;
...
public class JwtAuthenticationConfigurer<H extends HttpSecurityBuilder<H>> extends
    ...
    private List<JwtTokenExtractor> jwtTokenExtractors = new ArrayList<>(Collections.singletonList(HttpHeaderJwtTokenExtractor.INSTANCE));
