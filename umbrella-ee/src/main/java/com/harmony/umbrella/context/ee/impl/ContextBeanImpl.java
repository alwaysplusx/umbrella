 ...
 */
package com.harmony.umbrella.context.ee.impl;
...
public class ContextBeanImpl implements ContextBean {
	...
	protected final BeanDefinition bd;
	protected Object bean;
	protected String jndi;
	protected boolean wrapped;

	public ContextBeanImpl(BeanDefinition bd) {
		this.bd = bd;
	}

	public ContextBeanImpl(BeanDefinition bd, String jndi, Object bean, boolean wrapped) {
		this.bd = bd;
		this.bean = bean;
		this.jndi = jndi;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ContextBeanImpl other = (ContextBeanImpl) obj;
		if (bd == null) {
			if (other.bd != null)
				return false;
