...
public abstract class AbstractFileResolvingResource extends AbstractResource {
     ...
     * call. <p>Calls {@link ResourceUtils#useCachesIfNecessary(URLConnection)}
     * and delegates to {@link #customizeConnection(HttpURLConnection)} if
     * possible. Can be overridden in subclasses.
     * 
     * @param con
     ...
     * call. <p>Sets request method "HEAD" by default. Can be overridden in
     * subclasses.
     * 
     * @param con
