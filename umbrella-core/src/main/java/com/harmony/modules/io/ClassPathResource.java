...
import com.harmony.modules.utils.ObjectUtils;
 ...
 *
 * <p>Supports resolution as {@code java.io.File} if the class path resource
...
public class ClassPathResource extends AbstractFileResolvingResource {
     ...
     * will not accept it. <p>The thread context class loader will be used for
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ClassPathResource) {
            ...
            return (this.path.equals(otherRes.path) && ObjectUtils.nullSafeEquals(this.classLoader, otherRes.classLoader) && ObjectUtils.nullSafeEquals(
