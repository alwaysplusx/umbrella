...
import com.harmony.umbrella.ws.ee.ser.UserWebService;
...
public class UserProxyTest {
    ...
    public static void beforeClass() throws Exception {
        ...
        props.put("jdbc.harmonycore", "new://Resource?type=DataSource");
        props.put("jdbc.harmonycore.JdbcDriver", "org.h2.Driver");
        props.put("jdbc.harmonycore.JdbcUrl", "jdbc:h2:file:~/.h2/harmony/data");
        props.put("jdbc.harmonycore.UserName", "sa");
        props.put("jdbc.harmonycore.Password", "");
        props.put("jdbc.harmonycore.JtaManaged", "true");
