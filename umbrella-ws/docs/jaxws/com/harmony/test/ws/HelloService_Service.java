 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://www.harmony.com/test/hi", wsdlLocation = "http://localhost:8080/hi?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://www.harmony.com/test/hi", "HelloService");
    ...
    public HelloService getHelloWebServicePort() {
        return super.getPort(new QName("http://www.harmony.com/test/hi", "HelloWebServicePort"), HelloService.class);
    }
    ...
    public HelloService getHelloWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.harmony.com/test/hi", "HelloWebServicePort"), HelloService.class, features);
    }
