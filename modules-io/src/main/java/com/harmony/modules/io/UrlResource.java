...
public class UrlResource extends AbstractFileResolvingResource {
    ...
    /**
     * Create a new UrlResource based on a URL path. <p>Note: The given path
     * needs to be pre-encoded if necessary.
     * 
     * @param path
     *            a URL path
     * @throws MalformedURLException
    ...
    /**
     * Create a new UrlResource based on a URI specification. <p>The given parts
     * will automatically get encoded if necessary.
     * 
     * @param protocol
     ...
     * "UseCaches" flag to {@code false}, mainly to avoid jar file locking on
     * Windows.
     * 
