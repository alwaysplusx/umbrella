 ...
 * typical behavior.
 *
 * <p>The "exists" method will check whether a File or InputStream can be
 * opened; "isOpen" will always return false; "getURL" and "getFile" throw an
...
public abstract class AbstractResource implements Resource {
    ...
    public long contentLength() throws IOException {
        ...
        if(is == null)
            throw new IOException(getFilename() + " not find");
        try {
            long size = 0;
    ...
    /**
     * Determine the File to use for timestamp checking. <p>The default
     * implementation delegates to {@link #getFile()}.
     * 
