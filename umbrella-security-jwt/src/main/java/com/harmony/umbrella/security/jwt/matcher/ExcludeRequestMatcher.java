package com.harmony.umbrella.security.jwt.matcher;
...
public class ExcludeRequestMatcher implements RequestMatcher {
    ...
    public ExcludeRequestMatcher(Map<String, List<HttpMethod>> excludeUrls) {
        this.excludeUrls = Collections.unmodifiableMap(excludeUrls);
    }
