...
import com.harmony.umbrella.cache.util.SerializationUtils;

/**
 * 命令消息封装 格式：
 * <ul>
 * <li>第1个字节为命令代码，长度1 [OPT]
 * <li>第2、3个字节为region长度，长度2 [R_LEN]
 * <li>第4、N 为 region 值，长度为 [R_LEN]
 * <li>第N+1、N+2 为 key 长度，长度2 [K_LEN]
 * <li>第N+3、M为 key值，长度为 [K_LEN]
 * </ul>
 * 
 * @author winterlau
 */
