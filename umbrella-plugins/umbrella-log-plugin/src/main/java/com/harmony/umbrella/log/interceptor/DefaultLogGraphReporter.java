 ...
 */
public class DefaultLogGraphReporter implements LogGraphReporter {

    private ApplicationContext applicationContext;
    private TemplateFactory templateFactory;

    public DefaultLogGraphReporter() {
        this(ApplicationContext.getApplicationContext(), new MessageTemplateFactory());
    }

    public DefaultLogGraphReporter(TemplateFactory templateFactory) {
        this(ApplicationContext.getApplicationContext(), templateFactory);
    }

    public DefaultLogGraphReporter(ApplicationContext applicationContext, TemplateFactory templateFactory) {
