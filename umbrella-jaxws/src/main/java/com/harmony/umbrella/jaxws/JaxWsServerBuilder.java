...
public class JaxWsServerBuilder {
    ...
    protected Server doPublish(Class<?> serviceClass, String address, JaxWsServerFactoryConfig factoryConfig) {
        ...
        final Object target;
        try {
            target = getBeanFactory().getBean(serviceClass);
            JaxWsServerFactoryBean factoryBean = new JaxWsServerFactoryBean();
            if (factoryConfig != null) {
                factoryConfig.config(factoryBean);
                if (factoryBean.getServer() != null) {
                    log.error("config factory not allow call create method");
            ...
            factoryBean.setServiceBean(target);
     ...
     */
    public JaxWsServerBuilder setBeanFactory(BeanFactory beanFactory) {
