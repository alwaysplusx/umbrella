 ...
 *
 * <p>Consider using Spring's Resource abstraction in the core package for
 * handling all kinds of file resources in a uniform manner.
 ...
 * is to support {@link Log4jConfigurer}, which must be able to resolve resource
...
public abstract class ResourceUtils {
    ...
    /**
     * Resolve the given resource location to a {@code java.net.URL}. <p>Does
     * not check whether the URL actually exists; simply returns the URL that
...
//		Assert.notNull(resourceLocation, "Resource location must not be null");
     ...
     * file in the file system. <p>Does not check whether the file actually
     * exists; simply returns the File that the given location would correspond
     * to.
     * 
     * @param resourceLocation
     *            the resource location to resolve: either a "classpath:" pseudo
...
//		Assert.notNull(resourceUri, "Resource URI must not be null");
    ...
    public static boolean isJarURL(URL url) {
        String protocol = url.getProtocol();
        return (URL_PROTOCOL_JAR.equals(protocol) || URL_PROTOCOL_ZIP.equals(protocol) || URL_PROTOCOL_VFSZIP.equals(protocol) || URL_PROTOCOL_WSJAR
                .equals(protocol));
    }
     ...
     * encoding first. <p>Furthermore, this method works on JDK 1.4 as well, in
     * contrast to the {@code URL.toURI()} method.
     * 
     * @param url
