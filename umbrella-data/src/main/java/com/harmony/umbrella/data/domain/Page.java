...
public interface Page<T> extends Iterable<T> {
	...
	/**
	 * Returns the number of total pages.<p>总页数
	 * 
	...
	/**
	 * Returns the page content as {@link List}. <p>页面内容
	 * 
	 * @return
	 */
	List<T> getContent();
	...
	/**
	 * Returns the sorting parameters for the. <p>排序信息
	 * 
	 * @return
	 */
	Sort getSort();
	...
	/**
	 * Returns whether the has content at all. <p>页面是否包含内容
	 * 
	 * @return
	 */
	boolean hasContent();
	...
	/**
	 * Returns whether the current is the first one. <p>是否是第一页
	 * 
	 * @return
	 */
	boolean isFirst();
	...
	/**
	 * Returns whether the current is the last one.<p>是否为最后一页
	 * 
	 * @return
	 */
	boolean isLast();
	...
	/**
	 * Returns if there is a next.<p>是否有下一页
	 * 
	...
	/**
	 * Returns if there is a previous.<p>是否有上一页
	 * 
