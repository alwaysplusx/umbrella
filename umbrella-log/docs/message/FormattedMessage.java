...
/**
 * Handles messages that contain a format String. Dynamically determines if the
 * format conforms to MessageFormat or String.format and if not then uses
 * ParameterizedMessage to format.
 */
public class FormattedMessage implements Message, Serializable {

    private static final long serialVersionUID = 2178717662997369741L;
    ...
    public String toString() {
        return "FormattedMessage[messagePattern=" + messagePattern + ", args=" + Arrays.toString(argArray) + ']';
    }
